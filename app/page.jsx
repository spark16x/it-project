...
export default function Page() {
  return (
    <main className="min-h-screen w-full bg-gradient-to-b from-black to-blue-900 text-white flex flex-col items-center px-6 py-10">
      {/* Hero Section */}
      <section className="max-w-4xl text-center space-y-6 mt-10">
        <div className="flex justify-center">
          <School className="h-20 w-20 text-blue-400" />
        </div>
        <h1 className="text-4xl font-bold tracking-wide">EDUDEL.LITE</h1>
        <p className="text-blue-200 text-lg">Fast. Modern. Smart school management for the future.</p>
        <div className="flex gap-4 justify-center mt-6">
          <Button className="bg-blue-600 hover:bg-blue-500 px-6 py-2 rounded-xl">Login</Button>
          <Button variant="outline" className="border-blue-400 text-blue-300 hover:bg-blue-500/20 px-6 py-2 rounded-xl">Register</Button>
        </div>
      </section>

      {/* Features Section */}
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mt-20 w-full">
        <Card className="bg-blue-950/40 border-blue-500/30 text-white backdrop-blur-md">
          <CardHeader>
      ...
      <section className="mt-24 text-center space-y-6">
        <h2 className="text-3xl font-semibold">Start Managing Your School Smarter</h2>
        <p className="text-blue-300">Join thousands of schools upgrading their workflows.</p>
        <Button className="bg-blue-600 hover:bg-blue-500 px-8 py-3 text-lg rounded-xl">Get Started</Button>
      </section>
    </main>
  );
}
